  ...
  request({ url, json: true }, (error, { body }) => {
    if (error) {
      ...
      const data = body.daily.data[0].summary + ' It is currently ' + body.currently.temperature + ' degrees out. There is ' +
             body.currently.precipProbability + '% chance of rain. The high for today is ' + body.daily.data[0].temperatureHigh +
             ' degrees, and the low for today is ' + body.daily.data[0].temperatureLow + ' degrees.';
